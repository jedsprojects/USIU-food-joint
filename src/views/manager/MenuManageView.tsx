      ...
      {showAddForm && (
        <div className="glass-panel" style={{ padding: '20px', borderRadius: 'var(--radius-card)', border: '1px solid var(--color-primary)', marginBottom: '24px' }}>
          ...
          <form onSubmit={handleCreate} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <input type="text" placeholder="Item Name (e.g. Gavo Street Burger)" value={name} onChange={e => setName(e.target.value)} required style={{ width: '100%', background: 'var(--color-surface-container)', border: 'none', padding: '10px', borderRadius: '8px', color: '#fff', outline: 'none' }} />
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <input type="number" step="1" placeholder="Price (Ksh)" value={price} onChange={e => setPrice(e.target.value)} required style={{ flex: 1, background: 'var(--color-surface-container)', border: 'none', padding: '10px', borderRadius: '8px', color: '#fff', outline: 'none' }} />
              <select value={category} onChange={e => setCategory(e.target.value)} style={{ flex: 1, background: 'var(--color-surface-container)', border: 'none', padding: '10px', borderRadius: '8px', color: '#fff', outline: 'none' }}>
                ...
                <option value="Street Favorites">Street Favorites</option>
                <option value="Fries &amp; Loaded">Fries &amp; Loaded</option>
                <option value="Noodles">Noodles</option>
                <option value="Bhajia Corner">Bhajia Corner</option>
      ...
      {editingProduct && (
        <div className="glass-panel" style={{ padding: '20px', borderRadius: 'var(--radius-card)', border: '1px solid var(--color-tertiary)', marginBottom: '24px' }}>
          ...
          <form onSubmit={handleEditSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <input type="number" step="1" value={editingProduct.price} onChange={e => setEditingProduct({ ...editingProduct, price: parseFloat(e.target.value) || 0 })} required style={{ flex: 1, background: 'var(--color-surface-container)', border: 'none', padding: '10px', borderRadius: '8px', color: '#fff', outline: 'none' }} />
        ...
        {products.map(product => (
          <div key={product.id} className="glass-panel" style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p className="font-price-display" style={{ color: 'var(--color-tertiary-fixed)', fontSize: '14px', marginTop: '2px' }}>Ksh {product.price}</p>
            </div>
