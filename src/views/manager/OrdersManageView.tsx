          ...
          return (
            <div 
              ...
              style={{ 
                ...
                border: isSelected ? '1px solid var(--color-primary)' : '1px solid rgba(255, 177, 196, 0.1)',
                padding: '16px',
            ...
            >
              ...
              >
                ...
                <div style={{ textAlign: 'right', display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div>
                    <span className="font-price-display" style={{ color: 'var(--color-tertiary-fixed)', fontSize: '16px', display: 'block' }}>${order.total.toFixed(2)}</span>
              ...
              {isSelected && (
                <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid rgba(255, 177, 196, 0.1)' }}>
                  {/* Items List */}
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    {order.items.map((item, idx) => (
                      <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', margin: '4px 0' }}>
                        ...
                        <span style={{ color: 'var(--color-on-surface-variant)' }}>${(item.product.price * item.quantity).toFixed(2)}</span>
                      </div>
                    ))}
                  </div>
