  ...
  return (
    <main className="order-confirm-view app-view app-view--inset fade-in-up" style={{ textAlign: 'center' }}>
      ...
      <div style={{ marginTop: '24px', marginBottom: '24px' }}>
        ...
        <p className="font-body-md" style={{ color: 'var(--color-on-surface-variant)', marginTop: '6px' }}>Your gourmet selection is locked in!</p>
      </div>
      ...
      <div className="glass-panel" style={{ 
        padding: '16px', 
        borderRadius: 'var(--radius-card)', 
        border: '1px solid rgba(255, 177, 196, 0.05)',
        maxWidth: '320px',
        margin: '0 auto 32px auto',
        display: 'flex',
        flexDirection: 'column',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid rgba(255,177,196,0.1)', paddingTop: '8px' }}>
          ...
          <span className="font-price-display" style={{ color: 'var(--color-tertiary-fixed)', fontSize: '16px' }}>${order.total.toFixed(2)}</span>
        </div>
      </div>
