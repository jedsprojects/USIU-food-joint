...
export default function LoginView({ onNavigate, returnTo = 'home' }: Props) {
  ...
  const handleSuccess = () => {
    addToast('Welcome to Velvet Crumbs!', 'success', 'check_circle');
    onNavigate(returnTo);
  };
  ...
  return (
    <main className="app-view app-view--inset fade-in-up">
      ...
      <div className="glass-panel" style={{ display: 'flex', padding: '4px', borderRadius: 'var(--radius-full)', marginBottom: '24px', border: '1px solid rgba(255, 177, 196, 0.15)' }}>
