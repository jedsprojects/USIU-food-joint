  ...
  return (
    <div className="detail-view app-view--detail fade-in-up">
        ...
        <div className="detail-view__card">
          ...
          <div className="detail-view__card-body">
            <div className="detail-view__card-header">
              ...
              <span className="font-price-display" style={{ color: 'var(--color-primary-container)', flexShrink: 0 }}>Ksh {product.price}</span>
            </div>
            {product.rating && (
      ...
      {product.contains && product.contains.length > 0 && (
        <section className="detail-view__section">
          <h4 className="font-headline-md" style={{ color: 'var(--color-on-surface)', marginBottom: 'var(--space-sm)' }}>What's Inside</h4>
